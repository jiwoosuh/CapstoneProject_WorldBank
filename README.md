...
![Web App Flowchart](images/docx2dash_flow.png)
...
![Interactive Visualization Example](images/dashboard_image.png)

6. Please be sure to replace the 'Financial_Diaries_final.csv' with the real dataset. The current 'Financial_Diaries_final.csv' is a dummy dataset that is randomly generated by us to protect any information of respondents.
